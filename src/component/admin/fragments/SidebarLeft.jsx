...
const SidebarLeft = () => {
    ...
    return (
        <div style={{ display: 'flex', height: '100%', minHeight: '400px' }}>
            <Sidebar>
                <Menu>
                    <SubMenu label="QUẢN LÝ NHÂN SỰ" icon={<i className="fa fa-user" aria-hidden="true"></i>}>
                    ...
                    <SubMenu label="QUẢN LÝ PHÒNG" icon={<i className="fa fa-calendar" aria-hidden="true"></i>}>
                    ...
                    <SubMenu label="QUẢN LÝ THỐNG KÊ" icon={<i className="fa fa-bar-chart" aria-hidden="true"></i>}>
                        <MenuItem routerLink={<Link to="/admin/room/room-console" />}>Giám sát phòng</MenuItem>
                        <MenuItem routerLink={<Link to="/admin/room/room-booking-request" />}>Yêu cầu đặt phòng</MenuItem>
                    </SubMenu>
                </Menu>
